      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <div className="flex h-full w-full flex-col overscroll-none">{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto overscroll-contain touch-pan-y group-data-[collapsible=icon]:overflow-hidden",
          className,
        )}
        {...props}
      />
